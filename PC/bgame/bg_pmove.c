...
UInt32 viewLerp_StandCrouch_storage[32] = {
...
__attribute__((used, aligned(4)))
UInt32 viewLerp_CrouchStand_storage[32] = {
...
__attribute__((used, aligned(4)))
UInt32 viewLerp_CrouchProne_storage[40] = {
...
__attribute__((used, aligned(4)))
UInt32 viewLerp_ProneCrouch_storage[24] = {

...
static char buffer[1024]; /* 0xe86a20 */
static cg_t cgArray[1]; /* 0xd93080 */
static cgs_t cgsArray[1]; /* 0xd84880 */
static centityArray_t cg_entitiesArray[1]; /* 0xcfb880 */
static cg_weaponsArray_t cg_weaponsArray; /* 0xcede80 */
static cg_itemsArray_t cg_itemsArray; /* 0xceba80 */
static Bool g_ambientStarted; /* 0xe86a1d */
static Bool g_mapLoaded; /* 0xe86a1c */
static const char * cg_soundRoomTypes[27]; /* 0x311b80 */
static const char * cg_drawSoundOverlayStrings[5]; /* 0x311bec */
static const char * cg_drawFpsNames[5]; /* 0x311c00 */

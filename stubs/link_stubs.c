...
char cg[64] __attribute__((aligned(4))) = {0};
...
char cgs[64] __attribute__((aligned(4))) = {0};
...
char cl[64] __attribute__((aligned(4))) = {0};
char clc[64] __attribute__((aligned(4))) = {0};
...
char cls_ptr_195ecac[64] __attribute__((aligned(4))) = {0};
...
char FindNextComponent[64] __attribute__((aligned(4))) = {0};
...
char g_dx[64] __attribute__((aligned(4))) = {0};
char g_dxCaps[64] __attribute__((aligned(4))) = {0};
char g_dxIter[64] __attribute__((aligned(4))) = {0};
...
char gluCheckExtension[64] __attribute__((aligned(4))) = {0};
char gluOrtho2D[64] __attribute__((aligned(4))) = {0};
...
char __mh_execute_header[64] __attribute__((aligned(4))) = {0};
...
char r_device_ptr[64] __attribute__((aligned(4))) = {0};
...
char r_glob_ptr[64] __attribute__((aligned(4))) = {0};
...
char r_rendererGlob[64] __attribute__((aligned(4))) = {0};
